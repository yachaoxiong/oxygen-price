...
export function LoadingStitch({ className }: LoadingStitchProps): ReactElement {
  return (
    <div
      className={`relative flex min-h-screen w-full items-center justify-center overflow-hidden gradient-bg-vertical text-[#00ff41] ${
        className ?? ""
      }`}
    >
      <div className="pointer-events-none absolute inset-0 loading-stitch-grid grid-mask opacity-40" />
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0%,rgba(5,5,5,0.7)_100%)]" />
      ...
      <main className="relative z-20 flex flex-col items-center justify-center -translate-y-8">
        <div className="relative mb-12 flex h-80 w-80 items-center justify-center">
          ...
          <div className="absolute inset-0 grid-mask flex items-center justify-center">
            <div className="h-full w-full rounded-lg border border-[#00ff41]/10" />
          </div>
        ...
        <div className="relative flex flex-col items-center">
          <div className="flex items-center gap-6">
            <div className="h-6 w-px bg-gradient-to-t from-transparent via-[#00ff41]/30 to-transparent" />
            <h1 className="flex font-mono text-lg uppercase tracking-[0.4em] text-[#00ff41]">
          ...
          <div className="mt-4 h-px w-48 bg-gradient-to-r from-transparent via-[#00ff41]/20 to-transparent" />
        </div>
      </main>

      <div className="fixed left-12 top-12 h-10 w-10 border-l border-t border-[#00ff41]/20" />
      <div className="fixed right-12 top-12 h-10 w-10 border-r border-t border-[#00ff41]/20" />
      <div className="fixed bottom-12 left-12 h-10 w-10 border-b border-l border-[#00ff41]/20" />
      <div className="fixed bottom-12 right-12 h-10 w-10 border-b border-r border-[#00ff41]/20" />

      <div className="fixed bottom-12 left-1/2 flex -translate-x-1/2 gap-4 opacity-20">
        <div className="h-3 w-px bg-[#00ff41]" />
        <div className="h-5 w-px bg-[#00ff41]" />
        <div className="h-2 w-px bg-[#00ff41]" />
        <div className="h-4 w-px bg-[#00ff41]" />
        <div className="h-3 w-px bg-[#00ff41]" />
      </div>
    </div>
  );
